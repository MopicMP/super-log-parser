...
> Super parse and analyze log files

[![PyPI version](https://badge.fury.io/py/super-log-parser.svg)](https://pypi.org/project/super-log-parser/)
...
from super_log_parser import batch
